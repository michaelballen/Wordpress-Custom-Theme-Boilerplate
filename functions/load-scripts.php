...
function register_scripts () {
	...
	wp_register_script('modernizr', get_bloginfo('template_directory') . '/js/vendor/modernizr.js');
	wp_register_script('respond', get_bloginfo('template_directory') . '/js/vendor/respond.min.js');
